...
# Replace these with your Plotly username and API key
username = 'Anshuplotly'
api_key = 'xforconfidentiality'
...
# Upload the figure and get the URL
py.plot(fig, filename='Apple Stock Close Price with Key Events', auto_open=True)
